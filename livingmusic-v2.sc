...
synthDefFunc ={
	SynthDef(\help_sinegrain, 
		{ arg out=0, freq=440;
			var env;
			4.do({arg index;
			env = EnvGen.kr(Env.linen(((dnaL.at(25)/dnaR.at(25))*noteLength)+0.05, noteLength/2, ((dnaL.at(25)/dnaR.at(25))*noteLength)+0.05, (oscVol.at(index))*0.15), doneAction:2);
...
maxLifeFunc = {
	maxLife=(dnaL.at(32) * dnaR.at(32))*4;
	};
// -- end routine
